...
## Documentation
- Check out the [Wiki](https://github.com/Serial-IO/serial/wiki) section on how to use this library.
...
## Licence
GPLv2.0 - Check [LICENSE](https://github.com/Serial-IO/serial/blob/main/LICENSE) for more details.
